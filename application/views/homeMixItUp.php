...
<div class="selectContainer">
	...
	//}
	?>
	<div class="item mix text-center <?php echo ($product->category_id);?>"><img width="200px" src=<?php echo $myfile;?> />
		<div class="productname" myid="<?php echo $product->id;?>"><?php echo $product->name;?></div>
		...
		(function($){
            ...
            $("#save-cart").click(function(){
                ...
                $.ajax({
                    ...
                    //data:{id:4,name:'3oek'},
                    data:{id:obj.find("#cartproductname").attr("myid") ,name:obj.find("#cartproductname").html(),amount:$("#productamount").val(),sellingprice:$("#sellingprice").val()},
                    type:'post'
                });
            });
		}(jQuery))
