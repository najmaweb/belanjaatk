...
<body>
    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    			<div class="contact-form">
	    				<h2 class="title text-center">Saran dan Masukan</h2>
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>belanjaatk.co.id.</p>
							<p>Surabaya, Jawa Timur</p>
							<p>Indonesia</p>
							<p>Telp: +62 031 595 0386</p>
							<p>Mobile: 08113093842 (WA)</p>
							<p>Mobile: 081803033263,081230841551</p>
							<p>Email: surya_kawitan@belanjaatk.co.id</p>
	    				</address>
    ...
    <script type="text/javascript" src="/assets/eshopper/js/gmaps.js"></script>
	<script src="/assets/eshopper/js/contact.js"></script>
