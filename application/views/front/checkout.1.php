				...
				<div class="row">
					<div class="col-sm-3">
						<div class="shopper-info">
							...
							<form>
								<input type="text" placeholder="Display Name" value="<?php echo $username?>">
					...
					<tbody>
						<tr>
							<td class="cart_product">
								<a href=""><img src="/assets/eshopper/images/cart/one.png" alt=""></a>
							</td>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="/assets/eshopper/images/cart/two.png" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">Colorblock Scuba</a></h4>
								<p>Web ID: 1089772</p>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="/assets/eshopper/images/cart/three.png" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">Colorblock Scuba</a></h4>
								<p>Web ID: 1089772</p>
